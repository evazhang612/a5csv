...
def compute_corpus_level_bleu_score(references: List[List[str]], hypotheses: List[Hypothesis]) -> float:
    ...
    print("length of reference:" + str(sum(isinstance(i, list) for i in references)))
    print("length of hypothesis" + str(sum(isinstance(i, list) for i in hypotheses)))
    print([[ref] for ref in references])
    print([hyp.value for hyp in hypotheses])
